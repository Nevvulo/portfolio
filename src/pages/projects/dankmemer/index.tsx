    ...
    <ProjectContentContainer direction="column">
      <FadeAnimatedContainer direction="column" layoutId={`header-${id}-1`}>
        ...
        <ProjectContentText>
          ...
          the currency system which allows users to build up a virtual currency
          that can be used to buy in-game items. This included the ability to
          work at a job throughout the real world day, buying commodities from a
          shop, stealing coins from other users and a slot machine - all
