        ...
        root: {
          ...
          fieldQuery: {
            Root: {
              type: "InlineFragment",
              objectTypeName: "Root",
              selection: { enableLearnPage: { fieldArguments: {}, fieldQuery: null } },
            },
          },
        },
      },
...
export const initData = {
  commitId: 44589,
  hash: "940169154999836",
  reducedExpression: {
    id: "8eoOlGEueIuoMlI_X4X_V",
    logs: {},
    type: "ObjectExpression",
    fields: {
      root: {
        id: "ZV39nwT2am_dOVXHlri2a",
        body: {
          id: "LWCXRLKPw1fL0HCEuabzw",
          logs: {},
          type: "ObjectExpression",
          fields: {
            enableLearnPage: {
              id: "DTyvKLjoz903uwJI5FAFV",
              type: "BooleanExpression",
              value: true,
              valueType: { type: "BooleanValueType" },
              logs: { evaluations: { "O-PLxZuH3HDN6bViGy3gX": 1 } },
            },
          },
        ...
        valueType: {
          ...
          parameterValueTypes: [{ type: "ObjectValueType", objectTypeName: "Query_root_args" }],
        },
        parameters: [{ id: "G0L_bte__NdIDX7Qf1Z-r", name: "rootArgs" }],
      },
    },
    metadata: { permissions: { user: {}, group: { team: { write: "allow" } } } },
...
export const vercelFlagDefinitions = {
  enableLearnPage: {
    ...
    origin:
      "https://app.hypertune.com/projects/5483/main/draft/logic?selected_field_path=root%3EenableLearnPage",
  },
};
