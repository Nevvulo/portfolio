...
export default function Home({ discordWidget, isLive: serverIsLive, staticLearnPosts, staticProjects, staticFeaturedSoftware, staticFeaturedGames, staticStreamSettings, staticUpcomingEvents, staticFeaturedContent }: HomeProps) {
  ...
  const featuredContent = staticFeaturedContent;
  const featuredGames = staticFeaturedGames;
    ...
    <>
      ...
      <SignedIn>
        <AuthenticatedHome
          ...
          streamSettings={staticStreamSettings}
                  ...
                  <ShortsCarousel ref={shortsCarouselRef}>
                    {shortsPosts.map((short) => (
                      <ShortCard
                        key={short.id}
                        onClick={() =>
                          setPlayingShortId(playingShortId === short.id ? null : short.id)
                        }
                      >
                        {playingShortId === short.id && short.youtubeId ? (
                          <ShortEmbed>
                            <iframe
