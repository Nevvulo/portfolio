...
describe("Contact Page", () => {
  ...
  test("displays contact instructions and social platforms", () => {
    ...
    const contactTexts =
      screen.queryAllByText(/security vulnerability/i).length > 0
        ? screen.getAllByText(/security vulnerability/i)
        : screen.queryAllByText(/privacy concern/i).length > 0
          ? screen.getAllByText(/privacy concern/i)
          : screen.queryAllByText(/shoot me an e-mail/i).length > 0
            ? screen.getAllByText(/shoot me an e-mail/i)
            : [];
